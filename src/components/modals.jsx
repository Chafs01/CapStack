...
import{canSaveDeal,dealLimit}from'../lib/plan.js';
      ...
      <div className="glass" style={{width:'100%',maxWidth:420,padding:'30px 28px',position:'relative'}}>
        ...
        {atCap&&(
          <div style={{background:'var(--warn-tint)',border:'1px solid var(--warn-brd)',padding:'11px 14px',marginBottom:12,fontSize:'var(--fs-4)',color:'var(--text)',lineHeight:1.5}}>
            The free plan keeps {dealLimit(user)} saved {dealLimit(user)===1?'deal':'deals'}, and you
            have {count}. Any paid plan removes the limit &mdash; or delete one you no longer
            need. Nothing you have saved is at risk.
